      ...
      <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="px-4 py-6 sm:px-0">
          <p className="text-xl text-gray-700 mb-8">
            ...
            entrepreneurship, and providing the tools and resources necessary
            for individuals to achieve financial independence, gain valuable
            skills, and thrive in today's economy.
          </p>
              ...
              {timeline.map((event, index) => (
                <div key={index} className="flex">
                  <div className="flex flex-col items-center mr-4">
                    <div className="w-12 h-12 bg-[#6951DC] rounded-full flex items-center justify-center text-white font-bold">
                      {event.year}
                    </div>
                    {index !== timeline.length - 1 && (
                      <div className="h-full w-0.5 bg-[#6951DC] mt-2"></div>
                    )}
                  </div>
                  <div>
          ...
          <section className="mb-12">
            ...
            <p className="text-xl text-gray-700 mb-8">
              ...
              leadership team is composed of dedicated professionals who are
              passionate about empowering communities and driving positive
              change. With diverse backgrounds and expertise, our team is
              committed to guiding BEIC towards achieving its mission and making
                ...
                <Card key={index}>
                  <CardContent className="p-6 flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-[#6951DC] mb-2">{member.title}</p>
                      <p className="text-gray-600">{member.bio}</p>
                      <div className="mt-4 flex space-x-2">
                        <Facebook className="w-5 h-5 text-gray-400 hover:text-[#6951DC] cursor-pointer" />
                        <Twitter className="w-5 h-5 text-gray-400 hover:text-[#6951DC] cursor-pointer" />
                        <Linkedin className="w-5 h-5 text-gray-400 hover:text-[#6951DC] cursor-pointer" />
                      </div>
                    </div>
                  </CardContent>
                </Card>
          ...
          <section className="mb-12">
            ...
            <p className="text-xl text-gray-700 mb-8">
              At the Black Economic Improvement Corporation (BEIC), our values
              guide everything we do. They are the foundation of our work and
              reflect our commitment to creating positive change in our
              communities. We are committed to these values as we work to
              empower individuals and uplift our communities.
            </p>
          ...
          <p className="text-xl text-gray-700 mb-8">
            At BEIC, by living these values, we aim to create a meaningful and
            lasting difference in the lives of those we serve, all while we
            continue to evolve and grow as an organization. We are committed to
            these principles and the positive change they foster in our
            communities.
          </p>
        </div>
      </main>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <p className="mb-4">
                ...
                our contact page, and a member of our team will be happy to
                assist you.
              </p>
