				...
				<div className="px-4 py-6 sm:px-0">
					<div className="prose max-w-none space-y-6">
						...
						<p className="font-bold">
							...
							Corporation (BEIC) website. By accessing or using
							our website, you agree to comply with and be bound
							by the following Terms of Service. Please read these
							terms carefully before using our website. If you do
							not agree with these terms, you should not use our
							website.
						</p>
						...
						<p>
							By using our website, you agree to these Terms of
							Service, as well as our Privacy Policy. These terms
						...
						<p>
							...
							website. By using our website, you represent and
							warrant that you meet this age requirement.
						</p>

						<h2 className="text-xl font-bold">2. License:</h2>
						<p>
							BEIC grants you a limited, non-exclusive,
							non-transferable, and revocable license to access
							and use our website for personal, non-commercial
							purposes. You agree not to use our website for any
						...
						<ul className="space-y-5">
							...
							<li>
								-Using the website for any unlawful purpose or
								to solicit others to perform or participate in
								any unlawful acts.
							</li>
							<li>
							...
							<li>
								...
								website or any related systems or networks.
							</li>
							<li>
							...
							<li>
								-Collecting or tracking the personal information
								of others without their consent.
							</li>
							<li>
								-Using the website to spam, phish, or engage in
								similar activities.
							</li>
						</ul>
						...
						<p>
							...
							property of BEIC or its content suppliers and is
							protected by intellectual property laws. You agree
							not to reproduce, duplicate, copy, sell, resell, or
							exploit any portion of the website without express
							written permission from BEIC.
						</p>
						...
						<p>
							...
							controlled by BEIC. We have no control over, and
							assume no responsibility for, the content, privacy
							policies, or practices of any third-party websites
							or services. You acknowledge and agree that BEIC
							shall not be responsible or liable for any damage or
							loss caused by or in connection with the use of any
							such content, goods, or services available through
						...
						<p>
							...
							"as-available" basis. BEIC makes no warranties,
							expressed or implied, regarding the operation or
						...
						<p>
							In no event shall BEIC, its directors, employees, or
						...
						<p>
							...
							BEIC and its officers, directors, employees, and
							agents from and against any claims, liabilities,
							damages, losses, costs, expenses, or fees (including
							reasonable attorneys' fees) arising from your use of
							the website or your violation of these Terms of
							Service.
						</p>
						...
						<p>
							BEIC reserves the right to modify or replace these
							Terms of Service at any time. We will notify you of
							any changes by posting the new Terms of Service on
							this page. Your continued use of the website after
