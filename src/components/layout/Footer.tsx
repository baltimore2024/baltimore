...
export default function Footer() {
	return (
		<footer className="bg-[#6951DC] p-[30px] md:py-[80px] md:h-[530px]  md:overflow-clip w-full ">
			<div className="text-white flex gap-8 flex-col container mx-auto md:flex-row">
