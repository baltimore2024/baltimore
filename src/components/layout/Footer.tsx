			...
			<div className='max-w-4xl mx-auto flex flex-col md:flex-row justify-between items-center'>
				<div className='mb-4 md:mb-0'>
					<h3 className='text-xl font-bold mb-2'>
						Join us in our initiatives to make a meaningful
						and lasting impact!
					</h3>
					<p className='max-w-md'>
						...
						aspects of personal and community growth, we aim
						to create a supportive and thriving environment
				...
				<div className='text-center md:text-right'>
					...
					<p className='mb-4'>
						Have questions or want to get involved? Reach out
						to us through our contact form, and a team member
