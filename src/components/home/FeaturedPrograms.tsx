      ...
      <div className="space-y-8">
        ...
        >
          ...
          <div className="relative z-10 max-w-4xl mx-auto text-white">
            <h3 className="text-2xl font-bold mb-4">
              Universal Vocational Institute of America (UVIA)
            </h3>
            <p className="mb-6">
              At BEIC, we are proud to offer a variety of programs designed to
              uplift and empower our community. Our initiatives focus on
              education, economic development, and community improvement,
              ensuring a holistic approach to building a brighter future.
            </p>
            <Button
              variant="outline"
              className="text-white border-white hover:bg-white hover:text-[#6951DC]"
            >
              Read more
            </Button>
          </div>
          ...
          >
            ...
            <div className="relative z-10 text-white">
              ...
              <p className="mb-6">
                ...
                tools and support they need to achieve their full potential.
              </p>
              <Button
                variant="outline"
        ...
        <div className="relative rounded-lg overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-4 bg-black bg-opacity-75 text-white">
            <h3 className="text-2xl font-bold mb-2">Cleaning up baltimore</h3>
            <p>Watch volunteers & partners clean up the community</p>
          </div>
        </div>
      </div>
    </div>
