        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-8 items-start">
          ...
          <div className=" top-0 left-0 right-0 p-4">
            ...
            <div className="relative h-full w-full">
              ...
              />
              <div className="absolute bottom-0 left-0 right-0 bg-[#6951DC] italic text-white p-2 text-center">
                <p className="text-sm flex items-center justify-center gap-3 font-medium">
                  <LocationIcon
